var PlayerPosition = require('../services').PlayerPosition;


exports.PlayerPositionList = (req, res, next) => {
    var query = {};
    ...
    PlayerPosition.getPlayerPositions(query, (ret) => {
        if(ret){
            res.json({
                status: "true",
                data: ret
        ...
        else
		{
			...
			data: ret.errors,
			message: 'PlayerPosition list not found!'})
		}
